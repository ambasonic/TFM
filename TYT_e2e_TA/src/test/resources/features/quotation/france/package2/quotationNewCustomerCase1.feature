...
Feature: Quotation Template with a New Customer France
  ...
  Scenario Outline: quotation
    ...
    Examples:
      ...
      | Toyota          | COROLLA | Hybride 122h Dynamic Business (2020) | Black metallic paint   | Sellerie tissu Noir |Metallic paint  | Front radar parking distance sensors| SARL        |   2       |Place du boulevard |       80      | VAUCRESSON     | 92420    |    5455566   |   Mr  |Bernard| Xavier   | Automation@france.fr  |KINTO ONE DECALAGE  |48        | 80000    |€ 398,19  |€ 650,00   |€ 280,00    |