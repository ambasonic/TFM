...
Feature: Quotation Duplication with an existing Customer France(change of duration and distance)
  ...
  Scenario Outline: quotation
    ...
    Examples:
      ...
      | Toyota          | COROLLA | Hybride 122h Dynamic Business (2020) | Black metallic paint   | Sellerie tissu Noir |Metallic paint | Front radar parking distance sensors|2BDEVELOPPEMENT | KINTO ONE DECALAGE  |60        | 120000     |     0    | Summer Tires |       4    |€ 410,38  |€ 650,00   |€ 280,00    |