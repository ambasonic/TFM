...
Feature: Create a quote with a new sole trader with additional number of vehicule and fuel card
  ...
  Scenario Outline: quotation
    ...
    |france | Toyota          | PROACE VERSO | 2.0 D LONG 180 D-4D AUTO LOUNGE (2020) | Steel Grey metallic paint |Leather Black |Metallic paint  |   1     |PROF.LIB      |  Place du Boulevard|       80      | Vaucresson | 92420    |    5787556   |   Mr  |Lumiere | Renard    | soleautomation@paris.fr  |KINTO ONE DECALAGE    |36        | 75000    |€ 1.210,27|€ 700,00   |Fuel card TOTAL|Fuel Card Total - Balance Pack| 3                |