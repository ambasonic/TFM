...
Feature: Quotation Template with an Existing Sole Trader France including Downpayment and relief vehicle
  ...
  Scenario Outline: quotation
    ...
    Examples:
      ...
      | Toyota          | YARIS HYBRIDE | 1.5 VVT-I HYBRID Dynamic (2019) | Manhattan Grey metallic |Cloth Black/Grey  |Metallic paint |COCCINELLE     | KINTO ONE DECALAGE |  80000     |36       |1500       |     4     |tires | Summer Tires       |yes                  |relief vehicle|€ 292,73   |€ 300,00   |