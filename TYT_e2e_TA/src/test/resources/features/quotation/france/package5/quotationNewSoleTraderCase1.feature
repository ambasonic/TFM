...
@france
@pck5case1france
Feature: Create a quote with a new sole trader including Downpayment and summer tires
...
#    And he scrolls down
    ...
    Examples:
      ...
      | Lexus           | RX    | 450h Luxe (2020) | Gris Titane métal. |Sièges Cuir Noir Inserts Noir |Pack Technology     |    1    |PROF.LIB      |  Place du Boulevard|       80      | Vaucresson | 92420    |    5787556   |   Mr  |Lumiere | Renard    | soleautomation@paris.fr  |KINTO ONE    |36        | 45000    |1500       |     4     |tires | Summer Tires       |€ 1.078,84 |€ 2.300,00     |