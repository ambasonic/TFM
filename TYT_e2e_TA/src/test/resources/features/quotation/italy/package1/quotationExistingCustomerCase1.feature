...
Feature: Quotation Template with an existing Customer Italy
  ...
  Scenario Outline: quotation
    ...
    Examples:
      ...
      | Toyota          | Yaris | 1.5 Hybrid Lounge Red/Bronze MY19 (2019) | Red Mica&Black metallic  | Cloth black/grey | LoJack Classic| Cifelli       | 48       | 80000    | 1            |TFM2_Delivery cost direct/broker from dealer to customer| € 304.99 | € 145.90   | € 189.10       |