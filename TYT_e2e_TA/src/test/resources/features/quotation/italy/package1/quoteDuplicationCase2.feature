...
Feature: Duplicate a quote and change of duration and distance with additional options
  ...
  Scenario Outline: quote duplication
    ...
    Examples:
      ...
      | Toyota          | Yaris | 1.5 Hybrid Lounge Red/Bronze MY19 (2019) | Red Mica&Black metallic  | Cloth black/grey | LoJack Classic| Cifelli       | 48       | 80000    | 1            |TFM2_Delivery cost direct/broker from dealer to customer| € 288.90 | € 140.88   | € 189.10       ||60       | 190000    | 1            | yes            | 2         | Flex Standard | 4          |€ 429.78    |