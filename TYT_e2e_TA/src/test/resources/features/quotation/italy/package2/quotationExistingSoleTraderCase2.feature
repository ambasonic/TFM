...
Feature: Quotation Template with an existing Sole Trader Italy including downpayment and relief vehicle
  ...
  Scenario Outline: quotation
    ...
    Examples:
      ...
      |Toyota      |  C-HR   |1.8H (122CV) E-CVT Dynamic (2019)|Dark grey Met with black roof| Leather interior and Alcantara| LoJack Classic| Touch2 with Go Plus (no MY20)| CARINI       |    48   | 100000 |      1       |TFM2_Delivery cost direct/broker from dealer to customer|   5000    |Anti-Theft LoJack Abbonamento > 34 mesi|€ 250.25  | € 189.10       |€ 1,100.00     |      yes     |