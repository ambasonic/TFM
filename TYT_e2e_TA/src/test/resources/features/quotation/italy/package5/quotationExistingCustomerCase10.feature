...
Feature: Quotation Template with an existing Customer Italy including PickUp and Delivery(Service)
  ...
  Scenario Outline: quotation
    ...
    Examples:
      ...
      | Lexus           | NX     |   Hybrid Luxury 4WD (2020)        | White pearl              | Dark Rose Luxury Leather with Shimamoku insert |Metallic paint |Panoramic roof | LoJack Classic       |CHIMAR SPA           |     48  | 60000  |1            |TFM2_Delivery cost direct/broker from dealer to customer|7000       | PickUp and Delivery|   yes            | € 750.97 | € 254.96   |€ 1,150.00  |€ 600.00    |€ 189.10        |