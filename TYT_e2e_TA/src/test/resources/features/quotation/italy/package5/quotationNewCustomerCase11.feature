...
Feature: Quotation Template with a New Customer Italy including TPL(Services)
  ...
  Scenario Outline: quotation
    ...
    And he go to the next page
    ##TODO il y a des ervices a ajouter ici: TPL exemption(500) & Theft, fire, glasses exemption(500)
    ...
    Examples:
      | car manufacturer| model | car type                  | color       | upholstery                                     |option                            | accessories    | legal entity    |  street_name   | street_number | city_name | zip_code | phone_number | title |surname| name         |     email     | birthDate   |duration |distance|paymentIndex | paymentMethod                                          |downPayment|optionPrice |accessoriesPrice|
      | Lexus           | NX    |  Hybrid Luxury 4WD (2020) | White pearl | Dark Rose Luxury Leather with Shimamoku insert |Panoramic roof and Metallic paint | LoJack Classic |Societa  Semplice|  Plaza del sol |       3       | Nichelino | 10045    |    5787556   |   Dr  |Silvio | Berluscozini | ac@milano.it  | 10/01/1947  |     48  | 60000  |1            |TFM2_Delivery cost direct/broker from dealer to customer|4500       |€ 700.00    |€ 272.06        |