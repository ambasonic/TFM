...
Feature: Quotation Template with an existing Customer Italy including Relief Vehicle
  ...
  Scenario Outline: quotation
    ...
    Examples:
      ...
      | Toyota          | Yaris |   1.5 Hybrid Active MY19 (2019)   | Silver metallic  | Cloth black/grey |Metallic paint | LoJack Premium | Portabici Sx|CHIMAR SPA    |1            |TFM2_Delivery cost direct/broker from dealer to customer|Fuel Card EdenRed|yes                      | € 390.46 | € 130.11   |€ 700.00    |€ 272.06        |€ 161.22         |