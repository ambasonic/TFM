...
Feature: Quotation Template with a new Private customer Italy including vehicles with combinaison of services(fuel card)
  ...
  Scenario Outline: quotation
    ...
    Examples:
      | car manufacturer| model        | car type                                   | color       | upholstery      | accessories    | street_name   | street_number | city_name | zip_code | phone_number | title   |surname  | name         |     email     |duration |distance | paymentIndex |                   paymentMethod                        |insurance                              |Fuel card Eni|totalPrice|accessoriesPrice|
      | Toyota          | PROACE VERSO | 2.0D 150Cv S&S M/T L2 D Lounge 9 p. (2020) | White gloss | Dark grey cloth | LoJack Classic | Plaza del sol |       3       | Nichelino | 10042    |    5455566   |   Miss  |Silviana | Berluscozini | ac@milano.it  |36       |75000    |    1         |TFM2_Delivery cost direct/broker from dealer to customer|Anti-Theft LoJack Abbonamento > 34 mesi|yes          |€ 639.89  |€ 189.10        |
